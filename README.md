...
- 后台管理-卡片管理
  ...
  - 三种卡片类型：
    ...
    - http动态卡片：通过http接口动态获取的卡片显示内容。
      ...
      支持GET/POST，支持添加query参数，postbody支持form-data和json，认证支持自定义键值对、Basic、Bearer Token、Jwt Bearer
    
      支持对json结果进行jsonpath语法的取值。
    
    - sql动态卡片：通过sql动态获取的卡片显示内容
    
      支持mysql、postgresql、sqlserver三种数据库类型，sql必须只返回一列，结果默认取第一行第一列
...
![后台管理-普通卡片添加](https://gitee.com/tuituidan/pic/raw/master/2025/20250705115813784.png)

![后台管理-http卡片添加](https://gitee.com/tuituidan/pic/raw/master/2025/20250705120034247.png)

![](https://gitee.com/tuituidan/pic/raw/master/2025/20250705120401471.png)

![](https://gitee.com/tuituidan/pic/raw/master/2025/20250705120500614.png)

![](https://gitee.com/tuituidan/pic/raw/master/2025/20250705120522849.png)
